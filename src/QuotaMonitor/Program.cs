...
namespace QuotaMonitor
{
    ...
    internal static class Program
    {
        ...
        private static readonly string MutexName = "QuotaMonitor_SingleInstance";
        ...
        private static void Main(string[] args)
        {
            ...
            using (var mutex = new Mutex(true, MutexName, out createdNew))
            {
                if (!createdNew)
                {
                    MessageBox.Show("QuotaMonitor 已经在运行了。\n请到屏幕右下角托盘区域查看。",
                        "QuotaMonitor", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
